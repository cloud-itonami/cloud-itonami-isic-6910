# Operator Quickstart — Global Incorporation Actor

Shortest path from clone to a verified local dry-run for **ISIC 6910** (`cloud-itonami-isic-6910`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6910.git
...
- Blueprint governor key: `registrar-governor`
- Likely source path: `formation.governor.cljc`
